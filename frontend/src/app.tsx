        ...
        <div className='space-y-4'>
          <div className='flex items-center gap-3 px-5 h-16 bg-zinc-900 rounded-xl shadow-shape'>
            ...
            <div className='w-px h-6 bg-zinc-800'/>
              ...
              {isGuestInputOpen ? (
                <button className='flex items-center gap-2  bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium'>Alterar local/data</button>
              ) : (
            ...
            <div className='w-px h-6 bg-zinc-800'/>
              ...
              <button className='flex items-center gap-2  bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium'>Confirmar viagem?<ArrowRight className='size-5'/></button>
          </div>
